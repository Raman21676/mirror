...
/**
 * WebRTC DataChannel client manager for cross-network P2P connections.
 * Acts as the "offering" peer in WebRTC terminology.
 */
    ...
    fun createOffer() {
        ...
        ioScope.launch {
            try {
                    ...
                    override fun onCreateSuccess(sdp: SessionDescription?) {
                        peerConnection?.setLocalDescription(object : SdpObserver {
                            ...
                            override fun onSetSuccess() {
                                sdp?.description?.let {
                                    onSignalingData?.invoke(SignalingData("offer", it).toJson())
                                }
                            }
                ...
                Timber.e(e, "Error creating offer")
            }
        }
    }
    ...
    fun setRemoteAnswer(answerSdp: String) {
        ioScope.launch {
            ...
            peerConnection?.setRemoteDescription(object : SdpObserver {
                override fun onCreateSuccess(sdp: SessionDescription?) {}
                override fun onSetSuccess() { sendPendingIceCandidates() }
                override fun onCreateFailure(error: String?) {}
                override fun onSetFailure(error: String?) {}
            }, answer)
        }
